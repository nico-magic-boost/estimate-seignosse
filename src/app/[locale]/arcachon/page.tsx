  ...
  return (
    <main>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 reveal">
            <h1 className="text-3xl md:text-4xl font-bold mb-5 leading-tight">
              Estimation location de vacances à <span className="gradient-text">Arcachon</span> : calculez votre potentiel locatif
            </h1>
            ...
            <a href="#estimateur" className="inline-block bg-[#e8621a] hover:bg-[#cf5515] text-white font-semibold px-8 py-3 rounded-full transition-colors glow-pulse btn-shimmer-auto">
          ...
          <div className="flex-1 flex justify-center reveal-right">
            ...
            <img
              ...
              alt="Vue du Bassin d'Arcachon avec des villas en bord de mer, illustrant le potentiel de la location saisonnière"
          ...
          <div className="reveal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center reveal-stagger" role="list" aria-label="Avantages de l'estimateur">
              {[
                ...
                <div key={i} className="flex flex-col items-center gap-4 card-hover" role="listitem">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="reveal">
            ...
            <ul className="space-y-4" role="list" aria-label="Critères d'estimation">
              {[
              ...
              {[
                ...
                },
                {
                  ...
                  content: (<>
                    ...
                    <ul className="text-[#005f85] text-sm space-y-1 list-disc list-inside">
                ...
                <div key={i} className="flex flex-col gap-3 card-hover">
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="reveal">
            ...
            <ul className="space-y-2 mb-6" role="list" aria-label="Facteurs à prendre en compte">
              {['la concurrence locale', 'la réglementation en vigueur', 'la durée maximale de location', "les attentes des voyageurs (équipements, standing)"].map((item, i) => (
                <li key={i} className="flex items-center gap-2 text-gray-700 text-sm" role="listitem">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#007caa] flex-shrink-0" aria-hidden="true" />{item}
                </li>
              ))}
            </ul>
      ...
      <section className="py-16 px-4 bg-white border-t border-gray-100">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1 reveal-left">
            ...
            <ul className="space-y-4" role="list" aria-label="Avantages d'estimate.rentals">
              {[
          ...
          <div className="flex-1 reveal-right">
            ...
            <img
              ...
              alt="Propriétaire à Arcachon consultant l'outil estimate.rentals pour optimiser sa location saisonnière"
      ...
      <section className="mesh-gradient py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="reveal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mb-10 reveal-stagger" role="list" aria-label="Services des professionnels">
              {[
                ...
                <div key={i} className="flex flex-col items-center gap-4" role="listitem">
            ...
            <div className="text-center">
              <a href="#estimateur" className="inline-block bg-[#e8621a] hover:bg-[#cf5515] text-white font-semibold px-8 py-3 rounded-full transition-colors btn-shimmer">
      ...
      <section className="py-10 px-4 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-[#007caa] to-[#17a3b5] rounded-2xl px-10 py-10 flex flex-col md:flex-row items-center justify-between gap-6 reveal">
            <h2 className="text-2xl font-bold text-white leading-snug">
              Envie d&apos;estimer votre location de vacances à Arcachon ?
            </h2>
            <a href="/demander-une-demo" className="flex-shrink-0 bg-[#e8621a] hover:bg-[#cf5515] text-white font-semibold px-8 py-3 rounded-full transition-colors whitespace-nowrap glow-pulse btn-shimmer-auto">
              Demander une démo
            </a>
          </div>
        </div>
