        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            <h1 className="text-3xl md:text-4xl font-bold mb-5 leading-tight">
              Intégrer un estimateur de <span className="gradient-text">revenus locatifs</span> sur votre site internet
            </h1>
            ...
            <Link
              ...
              className="btn-shimmer-auto glow-pulse inline-flex items-center gap-2 bg-[#e8621a] hover:bg-[#cf5515] text-white font-semibold px-8 py-3 rounded-full transition-colors"
            >
