        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#007caa] text-white rounded-xl p-6">
              ...
              <p>Ayudar a los profesionales del alquiler vacacional a convertir más propietarios.</p>
            </div>
            <div className="bg-[#17a3b5] text-white rounded-xl p-6">
              <h3 className="font-bold text-xl mb-2">Nuestra visión</h3>
              <p>Convertirnos en la herramienta de referencia para la estimación de ingresos por alquiler en Europa.</p>
            </div>
          </div>
        </div>
      </div>
